...
function Achievement() {
  return (
    <section className="w-full bg-white py-12 px-8 lg:px-24 font-montserrat">
      {/* Top Row */}
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8">
        <h2 className="text-[52px] font-[500] text-gray-900 leading-[72.8px]">
          We’re Here to <br />
          <span className="text-[#C0392B] ">Guide You</span>
        </h2>
        <p className="max-w-[450px] text-gray-600 text-base mt-6 lg:mt-0 text-[16px] font-[400] leading-[28.8px]">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-stretch">
        ...
        <div className="flex flex-col gap-4 w-full lg:w-1/4">
          {/* Claim Settle Card */}
          <div className="bg-[#CD2200] text-white rounded-[40px] p-6 text-center shadow-md flex flex-col justify-center items-center flex-1">
