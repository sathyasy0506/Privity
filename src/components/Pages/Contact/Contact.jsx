          ...
          <div className="bg-white shadow-2xl rounded-3xl p-10 grid md:grid-cols-2 gap-10">
            ...
            <div className="md:col-span-2">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-gray-700">
                <p>
                  South <span className="font-semibold">+919961047677</span>
                </p>
                <p>
                  Central <span className="font-semibold">+919507332211</span>
                </p>
                <p>
                  North <span className="font-semibold">+919946780001</span>
                </p>
              </div>
            </div>
          </div>
